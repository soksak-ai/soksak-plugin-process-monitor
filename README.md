...
renders the revisioned owner snapshots available at mount and through its explicit `refresh`
command. It does not poll; live process events will be added when Core publishes the event surface.
